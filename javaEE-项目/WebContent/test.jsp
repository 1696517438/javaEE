...
<title>Insert title here</title><script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery-1.7.2.js"></script>
	...
	<div id="div_text" class="div_hide">
		<form action="" method="post" >
			<table bgcolor="AliceBlue">
				<tr>
					<td>公司名字</td>
					<td><input type="text" required name="rname"></td>
				</tr>
				<tr>
					<td>职位</td>
				...
				<tr>
					<td>公司要求</td>
					<td><textarea rows="5px" cols="23px" name="requires" style="resize: none"></textarea></td>
				</tr>
				<tr>
					<td>薪资待遇</td>
				...
				<tr>
					<td>职位描述</td>
					<td><textarea rows="5px" cols="23px" name="describes" style="resize: none"></textarea></td>
				</tr>
				<tr>
